...
namespace Server.Views
{
    partial class ItemInfoView
    {
        ...
        new DevExpress.XtraEditors.Controls.LookUpColumnInfo("IsBoss", "是否 Boss")
            ...
            // colRequiredGender
            // 
            colRequiredGender.Caption = "需求性别";
            ...
            // colExteriorEffect
            // 
            colExteriorEffect.Caption = "外观特效";
            ...
            SetLookUpEdit.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
        new DevExpress.XtraEditors.Controls.LookUpColumnInfo("SetName", "套装名称")
    });
